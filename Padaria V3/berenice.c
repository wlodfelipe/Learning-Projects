...
void escolha_main()
{
    ...
    case 3:
        remove("relatorio.txt");// apaga relatorio para nao ler o relatorio anterior
        sair();
        break;
...
void realizar_venda()
{
    ...
    // ler as informaçoes do venda.txt, que só tem 1 produto sempre
